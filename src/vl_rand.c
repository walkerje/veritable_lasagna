...
vl_float32_t vlRandF(vl_rand *rand) {
    ...
    const vl_uint32_t randFloatVal =
            ((vl_uint32_t) vlRandNext(rand) & VL_IEEE754_FLOAT32_LOW23) | VL_IEEE754_FLOAT32_ONE;
...
void vlRandFx2(vl_rand *rand, vl_float32_t *result) {
    ...
    *((vl_uint64_t *) result) =
            ((vl_uint64_t) vlRandNext(rand) & VL_IEEE754_FLOAT32_LOW23_DW) | VL_IEEE754_FLOAT32_ONE_DW;
    result[0] -= 1.0f;
    result[1] -= 1.0f;
#else
    vlRandF(rand, result);
...
vl_float64_t vlRandD(vl_rand *rand) {
    ...
    const vl_uint64_t randFloatVal =
            ((vl_uint64_t) vlRandNext(rand) & VL_IEEE754_FLOAT64_LOW52) | VL_IEEE754_FLOAT64_ONE;

...
void vlConditionSignal(vl_condition cond) { pthread_cond_signal((pthread_cond_t*)cond); }

void vlConditionBroadcast(vl_condition cond) { pthread_cond_broadcast((pthread_cond_t*)cond); }

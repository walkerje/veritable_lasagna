...
#define VL_COMPARE_FUNC(funcName, type)                                                                                \
    ...
    {                                                                                                                  \
        return (VL_DEREF(type, dataA) > VL_DEREF(type, dataB)) - (VL_DEREF(type, dataA) < VL_DEREF(type, dataB));      \
    }                                                                                                                  \
    vl_int_t funcName##Reverse(const void* dataA, const void* dataB)                                                   \
    {                                                                                                                  \
        return (VL_DEREF(type, dataB) > VL_DEREF(type, dataA)) - (VL_DEREF(type, dataB) < VL_DEREF(type, dataA));      \
    }

 ...
 * It offers fast pseudo-random number generation and passes Big Crush with
 * minimal state. All vlRand* functions are almost entirely branchless.
 */
 ...
 *
 * This function can be skipped entirely, assuming another seed integer can be
 * provided.
 *
 ...
 * \private
 */
static inline void vlRandSplitBytes(vl_rand* randPtr, void* resultPtr)
{
    const vl_ularge_t tmp = vlRandNext(randPtr);
    memcpy(resultPtr, &tmp, sizeof(tmp));
}
 ...
 * \par resultPtr pointer to where the result will be stored
 */
#define vlRandUInt8x8(randPtr, resultPtr)                                                                              \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \
 ...
 * \par Complexity of O(1) constant.
 */
#define vlRandUInt16x4(randPtr, resultPtr)                                                                             \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \
 ...
 * \par Complexity of O(1) constant.
 */
#define vlRandUInt32x2(randPtr, resultPtr)                                                                             \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \
 ...
 * \par Complexity of O(1) constant.
 */
#define vlRandInt8x8(randPtr, resultPtr)                                                                               \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \
 ...
 * \par Complexity of O(1) constant.
 */
#define vlRandInt16x4(randPtr, resultPtr)                                                                              \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \
 ...
 * \par Complexity of O(1) constant.
 */
#define vlRandInt32x2(randPtr, resultPtr)                                                                              \
    VL_H_RANDOM_SPLIT(randPtr, resultPtr);                                                                             \

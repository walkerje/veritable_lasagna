...
typedef enum vl_msgpack_type_
{
    ...
    VL_MSGPACK_STRING,
    /**
     * \brief MessagePack Binary. An arbitrary sequence of bytes with a
     * well-defined length.
     */
    VL_MSGPACK_BINARY,
    /**
     * \brief MessagePack Array. A sequence of dynamically-typed nodes of a
     * well-determined length.
     */
    VL_MSGPACK_ARRAY,

    /**
     * \brief MessagePack Map. A collection of node key-value pairs of an
     * arbitrary size.
     */
    VL_MSGPACK_MAP,

    /**
     * \brief MessagePack Extension Type. Has a type identifier in range of
     * 0...127 and arbitrary data.
     */
    VL_MSGPACK_EXT
} vl_msgpack_type;
 ...
 *
 * This structure represents an N-Tree with parent-child relationships that
 * accurately represents a MessagePack structure. It is implemented using a
 * hierarchical hash table for nodes and parent-child relationships, using
 * a separate arena allocator for node values. Nodes in this structure are
 * dynamically typed.
 *
 * The design of this structure is NOT completely compliant with the MessagePack
 * spec. It requires the two following rules to be enforced:
 *  1. Elements in a Map must ALWAYS have String keys (e.g, named elements).
 *  2. Elements in an Array must ALWAYS have Integer keys (e.g, indexed
 * elements), although their keys are implicit. This design choice simplifies
 * the implementation by disallowing complex structures such as Maps and Arrays
 * to act as Map keys, keeping it in line with formats comparable to JSON.
 *
 * All strings in and out of this structure, keys or values, are assumed to be
 * UTF-8 encoded.
 *
 ...
 *
 * The specified MessagePack must have been initialized via vlMsgPackInit before
 ...
 *
 * The specified MessagePack must have been initialized via vlMsgPackNew before
 * calling this function.
 *
 * ## Contract
 ...
 *
 * This function resets the MessagePack DOM instance without deallocating
 * memory. Previously allocated memory remains available for reuse, improving
 * performance when repeatedly decoding into the same structure.
 *
 ...
 * \return An iterator to the parent node, or an invalid iterator if the node
 * has no parent.
 */
 ...
 * \param pack The MessagePack DOM instance.
 * \param iter The iterator pointing to the current node.
 * \return An iterator to the first child node, or an invalid iterator if there
 * are no children.
 */
 ...
 * \param pack The MessagePack DOM instance.
 * \param iter The iterator pointing to the current node.
 * \return An iterator to the next sibling node, or an invalid iterator if there
 * is no next sibling.
 */
 ...
 * \param pack The MessagePack DOM instance.
 * \param iter The iterator pointing to the current node.
 * \return An iterator to the previous sibling node, or an invalid iterator if
 ...
 * \param pack The MessagePack DOM instance.
 * \param iter The iterator pointing to the current node.
 * \return The extension type value, or an undefined result if the node is not
 * an EXT type.
 */
 ...
 *
 * This function inserts an element of the specified MessagePack type and
 * optional extended type under a given parent node. The key and value are
 * copied into the internal storage, allowing external memory to be safely freed
 * after insertion.
 *
 * \param pack     The MessagePack DOM instance.
 ...
 */
VL_API vl_msgpack_iter vlMsgPackInsertExt(vl_msgpack* pack, vl_msgpack_type type, vl_int8_t subType,
                                          vl_msgpack_iter parent, const void* keyPtr, vl_memsize_t keyLen,
                                          const void* dataPtr, vl_memsize_t dataLen);
 ...
 * \return An iterator to the newly inserted element.
 */
static inline vl_msgpack_iter vlMsgPackInsert(vl_msgpack* pack, vl_msgpack_type type, vl_msgpack_iter parent,
                                              const void* keyPtr, vl_memsize_t keyLen, const void* dataPtr,
 ...
 *
 * This function removes the specified element and all its children from the
 * DOM. Memory may be reused depending on the allocator's behavior.
 *
 * \param pack  The MessagePack DOM instance.
 ...
 *
 * This function searches for a child under the given parent node with a
 * matching key.
 *
 * \param pack    The MessagePack DOM instance.
 ...
 * \param keyLen  Length of the key.
 * \return An iterator to the matching child or an invalid iterator if not
 * found.
 */
VL_API vl_msgpack_iter vlMsgPackFindChild(vl_msgpack* pack, vl_msgpack_iter parent, const void* key,
                                          vl_memsize_t keyLen);
 ...
 * found.
 */
static inline vl_msgpack_iter vlMsgPackFindChildNamed(vl_msgpack* pack, vl_msgpack_iter parent, const char* name)
{
 ...
 * \return An iterator to the indexed child or an invalid iterator if out of
 * bounds.
 */
 ...
 *
 * This function assumes the key is stored as an integer and returns it
 * directly.
 *
 * \param pack  The MessagePack DOM instance.
 * \param iter  The element iterator.
 ...
 */
static inline vl_dsidx_t vlMsgPackSampleKeyIndex(vl_msgpack* pack, vl_msgpack_iter iter)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetArrayNamed(vl_msgpack* pack, vl_msgpack_iter parent, vl_dsidx_t arrayLen,
                                                     const char* key)
{
 ...
 * \return An iterator to the newly inserted array.
 */
static inline vl_msgpack_iter vlMsgPackSetArrayIndexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_dsidx_t arrayLen,
                                                       vl_dsidx_t idx)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetBoolNamed(vl_msgpack* pack, vl_msgpack_iter parent, vl_bool_t value,
                                                    const char* key)
{
 ...
 * \return An iterator to the newly inserted boolean value.
 */
static inline vl_msgpack_iter vlMsgPackSetBoolIndexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_bool_t value,
                                                      vl_dsidx_t idx)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetIntNamed(vl_msgpack* pack, vl_msgpack_iter parent, vl_ilarge_t value,
                                                   const char* key)
{
 ...
 * \return An iterator to the newly inserted integer value.
 */
static inline vl_msgpack_iter vlMsgPackSetIntIndexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_ilarge_t value,
                                                     vl_dsidx_t idx)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetUIntNamed(vl_msgpack* pack, vl_msgpack_iter parent, vl_ularge_t value,
                                                    const char* key)
{
 ...
 *
 * This function inserts a new unsigned integer value with an integer index
 * under the specified parent node. The parent must be an array.
 *
 * \param pack   The MessagePack DOM instance.
 * \param parent The parent node where the unsigned integer value is inserted.
 * \param value  The unsigned integer value to insert.
 ...
 * \return An iterator to the newly inserted unsigned integer value.
 */
static inline vl_msgpack_iter vlMsgPackSetUIntIndexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_ularge_t value,
                                                      vl_dsidx_t idx)
{
 ...
 *
 * This function inserts a new 32-bit floating point value with a given name
 * (key) under the specified parent node. The parent must be a map.
 *
 * \param pack   The MessagePack DOM instance.
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetFloat32Named(vl_msgpack* pack, vl_msgpack_iter parent, vl_float32_t value,
                                                       const char* key)
{
 ...
 * \return An iterator to the newly inserted 32-bit float value.
 */
static inline vl_msgpack_iter vlMsgPackSetFloat32Indexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_float32_t value,
                                                         vl_dsidx_t idx)
{
 ...
 *
 * This function inserts a new 64-bit floating point value with a given name
 * (key) under the specified parent node. The parent must be a map.
 *
 * \param pack   The MessagePack DOM instance.
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetFloat64Named(vl_msgpack* pack, vl_msgpack_iter parent, vl_float64_t value,
                                                       const char* key)
{
 ...
 * \return An iterator to the newly inserted 64-bit float value.
 */
static inline vl_msgpack_iter vlMsgPackSetFloat64Indexed(vl_msgpack* pack, vl_msgpack_iter parent, vl_float64_t value,
                                                         vl_dsidx_t idx)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetStringNamed(vl_msgpack* pack, vl_msgpack_iter parent, const char* value,
                                                      const char* key)
{
 ...
 * \return An iterator to the newly inserted string value.
 */
static inline vl_msgpack_iter vlMsgPackSetStringIndexed(vl_msgpack* pack, vl_msgpack_iter parent, const char* value,
                                                        vl_dsidx_t idx)
{
 ...
 */
static inline vl_msgpack_iter vlMsgPackSetBinaryNamed(vl_msgpack* pack, vl_msgpack_iter parent, const void* value,
                                                      vl_memsize_t valLen, const char* key)
{
 ...
 * \return An iterator to the newly inserted binary value.
 */
static inline vl_msgpack_iter vlMsgPackSetBinaryIndexed(vl_msgpack* pack, vl_msgpack_iter parent, const void* value,
                                                        vl_memsize_t valLen, vl_dsidx_t idx)
{
 ...
 * \param defaultValue  The default value to return if the iterator is invalid
 * or type mismatch.
 ...
 *
 * This function retrieves the signed integer value from a given element
 * iterator. If the iterator is invalid or the element type does not match, a
 ...
 *
 * This function retrieves the unsigned integer value from a given element
 * iterator. If the iterator is invalid or the element type does not match, a
 * default value is returned.
 *
 * \param pack          The MessagePack DOM instance.
 ...
 * \param defaultValue  The default value to return if the iterator is invalid
 * or type mismatch.
 * \return The unsigned integer value stored in the element or the default
 * value.
 */
 ...
 *
 * This function retrieves the 32-bit floating point value from a given element
 * iterator. If the iterator is invalid or the element type does not match, a
 * default value is returned.
 *
 * \param pack          The MessagePack DOM instance.
 ...
 * \param defaultValue  The default value to return if the iterator is invalid
 * or type mismatch.
 * \return The 32-bit floating point value stored in the element or the default
 * value.
 */
 ...
 *
 * This function retrieves the 64-bit floating point value from a given element
 * iterator. If the iterator is invalid or the element type does not match, a
 * default value is returned.
 *
 * \param pack          The MessagePack DOM instance.
 ...
 * \param defaultValue  The default value to return if the iterator is invalid
 * or type mismatch.
 * \return The 64-bit floating point value stored in the element or the default
 * value.
 */

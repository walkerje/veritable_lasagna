 ...
 * \param dataSize  length of the data, in bytes. Usually this can be ignored
 * unless the data is variable in length.
 */
...
/**
 * \brief Generates a hash code for the 16-bit sequence at the specified
 * address. This is a direct bitcast of an 8-bit sequence to a 64-bit sequence.
 * The returned value will equal the value of the original sequence.
 * \param data pointer
 * \return hash code
 */
...
/**
 * \brief Generates a hash code for the 32-bit sequence at the specified
 * address.
 *
...
/**
 * \brief Generates a hash code for the 64-bit sequence at the specified
 * address.
 *
 * The returned value will equal the value of the original sequence.
 *
 ...
 * \return merged hash
 */
#define vlHashCombine(a, b) (vl_hash)(((a) ^ (b)) + 0xEF92DACB + ((a) << 6) + ((a) >> 2))
#endif

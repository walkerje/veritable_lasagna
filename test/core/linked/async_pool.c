...
vl_bool_t vlTestAsyncPoolMPMC() {
    ...
    {   //Descend the free stack to count free nodes.
        //This is a bit of a hack, but it's the only way to count the ACTUAL number of free nodes.
        //For a test, this should be fine.
        //Total number of free nodes should ALWAYS be <= the number of threads.

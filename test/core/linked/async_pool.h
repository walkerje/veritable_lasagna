...
VL_TEST_API vl_bool_t vlTestAsyncPoolBasic();

//Test high-contention scenario. A bunch of distributed takes/returns.
VL_TEST_API vl_bool_t vlTestAsyncPoolMPMC();

//Ensure all internal counters are reset and allow for re-use.
VL_TEST_API vl_bool_t vlTestAsyncPoolClearAndReuse();

//Ensure pool elements are properly aligned.
VL_TEST_API vl_bool_t vlTestAsyncPoolAlign();
